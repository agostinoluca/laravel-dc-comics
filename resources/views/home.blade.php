        ...
        <div class="row align-items-center ">
            <div class="col-4 p-5">
                <div class="text-center">
                    ...
                    <img class="rounded-2" style="aspect-ratio: 1;"
            ...
            <div class="col-4 p-5">
                <div class="text-center">
                    ...
                    <img src="https://www.focus.it/site_stored/imgs/0002/020/marvel_universe_219830.1020x680.jpg"
                        class="pb-5 rounded-2" alt="...">

                    <img class="rounded-2"
                        src="https://media-assets.wired.it/photos/62e2a7a861c1b80097b5d3ac/4:3/w_2011,h_1508,c_limit/book-novel-film-pattern-dc-textile-503799-pxhere.com.jpg"
                        alt="...">
